...
Article.create(:id=>4,:user_id=>1,:article_category_id=>1,:title=>'article4',:description=>'awegawegwa')
Article.create(:id=>5,:user_id=>1,:article_category_id=>1,:title=>'article5',:description=>'awegawegwa')
Article.create(:id=>6,:user_id=>1,:article_category_id=>1,:title=>'article6',:description=>'awegawegwa')
Article.create(:id=>7,:user_id=>1,:article_category_id=>1,:title=>'article7',:description=>'awegawegwa')
Article.create(:id=>8,:user_id=>1,:article_category_id=>1,:title=>'article8',:description=>'awegawegwa')
Article.create(:id=>9,:user_id=>1,:article_category_id=>1,:title=>'article9',:description=>'awegawegwa')
Article.create(:id=>10,:user_id=>1,:article_category_id=>2,:title=>'article2-1',:description=>'weahwaehwasdhasd')
Article.create(:id=>11,:user_id=>1,:article_category_id=>2,:title=>'article2-2',:description=>'sdahasdhwehaw')
Article.create(:id=>12,:user_id=>1,:article_category_id=>2,:title=>'article2-3',:description=>'awegawehawehwaehegwa')
